...
(function () {
  ...
  function studios() {
    return [
      { id: ST_TOMSON, name: "Томсон", address: "Томск, Красноармейская, 101", tel: "+7 961 887-80-78",
      ...
      /* Длинное имя нарочно: на нём и видно, как карточка обходится с тем,
         что не влезает в строку места. Слова «студия» в имени нет и быть не
         должно — его дописывает приложение, как «отель» к «Хилтону» */
      { id: ST_SFERA, name: "Сфера на Набережной", address: "Томск, Набережная реки Ушайки, 12",
  ...
  function spots() {
    return [
      { id: P + "sp_park",  name: "Лагерный сад",    address: "Томск, Лагерный сад",        town: "Томск", lat: 56.4520, lon: 84.9370, mt: Date.now() },
      { id: P + "sp_bereg", name: "Берег Томи",      address: "Томск, Московский тракт",    town: "Томск", lat: 56.4655, lon: 84.9280, mt: Date.now() },
      { id: P + "sp_bau",   name: "Дом с драконами", address: "Томск, Красноармейская, 68", town: "Томск", lat: 56.4703, lon: 84.9698, mt: Date.now() },
      { id: P + "sp_sol",   name: "Ресторан «Соль»", address: "Томск, Набережная, 20",      town: "Томск", lat: 56.4890, lon: 84.9600, mt: Date.now() }
    ];
  }
  ...
  function S(o) {
    var r = {
      ...
      /* Уточнение жанра: меняет у съёмки имя и знак, пресета не касается */
      sub: o.sub || "",
  ...
  function sessions() {
    ...
    return [
      ...
      S({ k: "aug_portr", d: -30, t: "portrait", sub: "business", min: H(12), dur: 60, c: "Сергей Плахов", tel: "+7 913 606-70-80",
      ...
      S({ k: "aug_burger", d: -22, t: "product", sub: "food", min: H(10), dur: 240, c: "Кофейня «Гренка»", tel: "+7 913 808-90-10",
          place: "Сфера на Набережной", addr: "Томск, Набережная реки Ушайки, 12",
      ...
      S({ k: "aug_conf", d: -12, t: "report", sub: "conference", min: H(9), dur: 9 * 60, c: "Форум «Сибирь»", tel: "+7 383 200-10-10",
      ...
      S({ k: "sep_party", d: -3, t: "party", sub: "jubilee", min: H(15), dur: 300, c: "Юбилей Нины Петровны", tel: "+7 913 010-20-30",
      ...
      S({ k: "sep_inter", d: 5, t: "architecture", sub: "interior", min: H(11), dur: 180, c: "Ресторан «Соль»", tel: "+7 913 222-33-44",
          org: ORG_REST, place: "Сфера на Набережной", addr: "Томск, Набережная реки Ушайки, 12",
      ...
      S({ k: "sep_pet", d: 7, t: "animals", sub: "dogs", min: H(11), dur: 60, c: "Ирина Со", tel: "+7 913 787-97-07",
      ...
      S({ k: "oct_ad", d: 25, t: "ad", sub: "fashion", min: H(10), dur: 8 * 60, c: "Марка «Фэшан»", tel: "+7 495 100-20-30",
      ...
      S({ k: "oct_cat", d: 45, t: "product", min: H(11), dur: 300, c: "Фабрика «Бауэр»", tel: "+7 913 444-55-66",
          org: ORG_FAB, place: "Сфера на Набережной", addr: "Томск, Набережная реки Ушайки, 12",
