...
(function (global) {
  ...
  DICT.ru = {
    ...
    "day.freeAllDay": "свободен весь день",
    ...
    "mb.mergeHint":      "Долгий тап включает сортировку: там подборки переставляют и объединяют",
    "mb.sortHint":       "Тащите, чтобы переставить · задержите над другой — объединить · минус — переименовать или убрать · тап мимо — выйти",
  ...
  DICT.en = {
    ...
    "mb.mergeHint":      "Long-press starts sorting: reorder and merge boards there",
    "mb.sortHint":       "Drag to reorder · hover over another to merge · minus to rename or remove · tap outside to finish",
  ...
  DICT.es = {
    ...
    "day.freeAllDay": "libre todo el día",
