 ...
 *
 * Пять языков: en, ru и zh заполнены, es/ja заведены пустыми словарями с
 ...
 *
 * Китайский собран из двух кусков внешнего перевода — первый со снимка
 * словаря, второй довёл отставшие ключи (знакомство, анкета для гостей,
 * обратная связь, комплекты и мелочь, появившиеся в `ru` между снимками) до
 * полного покрытия. Дальше словарь держать в ногу с `ru` придётся вручную —
 * автоматической сверки нет (см. DECISIONS.md, «Китайский словарь»). */
(function (global) {
  "use strict";
