...
(function (global) {
  ...
  DICT.ru = {
    ...
    /* ---- Яндекс.Диск ---- */
    "ya.title":        "Яндекс.Диск",
    "ya.connection":   "Подключение",
    "ya.lastUpload":   "Последняя выгрузка",
    "ya.on":           "подключён",
    "ya.off":          "не подключён",
    "ya.connect":      "Подключить Яндекс.Диск",
    "ya.disconnect":   "Отключить Яндекс.Диск",
    "ya.disconnected": "Отключено. Данные на устройстве и копия на Диске остались нетронутыми.",
    "ya.pull":         "Восстановить с Диска",
    "ya.note":         "Копия будет уходить в папку «Приложения · Light Plan». Остальной Диск приложению не виден.",
    "ya.reading":      "Читаю копию с Диска…",
    "ya.restored":     "Восстановлено с Диска. Перезапускаю…",
    "ya.pushFail":     "Не удалось выгрузить: {err}. Копия файлом по-прежнему работает.",
    "ya.failed":       "Не вышло: {err}",
    "ya.never":        "ещё не выгружали",
    "ya.errUpload":    "загрузка не прошла",
    "ya.errUploadCode": "не загрузилось ({code})",
    "ya.errNoCopy":    "на Диске ещё нет копии",
    "ya.errNotLinked": "Диск не подключён",
    "ya.errNoHref":    "Диск не дал ссылку",
    "ya.errNoFile":    "файла нет",
    "ya.errNoAccess":  "нет доступа",
  ...
  DICT.en = {
    ...
    "ya.title":        "Yandex Disk",
    "ya.connection":   "Connection",
    "ya.lastUpload":   "Last upload",
    "ya.on":           "connected",
    "ya.off":          "not connected",
    "ya.connect":      "Connect Yandex Disk",
    "ya.disconnect":   "Disconnect Yandex Disk",
    "ya.disconnected": "Disconnected. The data on the device and the copy on the Disk are untouched.",
    "ya.pull":         "Restore from the Disk",
    "ya.note":         "The backup goes to the “Applications · Light Plan” folder. The rest of the Disk is invisible to the app.",
    "ya.reading":      "Reading the backup from the Disk…",
    "ya.restored":     "Restored from the Disk. Restarting…",
    "ya.pushFail":     "Could not upload: {err}. The file backup still works.",
    "ya.failed":       "Did not work: {err}",
    "ya.never":        "never uploaded",
    "ya.errUpload":    "the upload failed",
    "ya.errUploadCode": "did not upload ({code})",
    "ya.errNoCopy":    "there is no backup on the Disk yet",
    "ya.errNotLinked": "the Disk is not connected",
    "ya.errNoHref":    "the Disk gave no link",
    "ya.errNoFile":    "no such file",
    "ya.errNoAccess":  "no access",
