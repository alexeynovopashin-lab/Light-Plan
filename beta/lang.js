 ...
 *
 * Китайский собран из внешнего перевода со снимка словаря — экраны знакомства
 * (`tour.*`), анкеты для гостей (`quest.*`), формы обратной связи (`fb.*`),
 * комплектов (`kit.*`) и часть более мелких ключей появились в `ru` уже
 * после снимка. Для них `zh` пока падает в английский честно, как и
 * задумано — это не баг, а нормальное состояние словаря, пока не пришёл
 * следующий кусок перевода (см. DECISIONS.md, «Китайский словарь»). */
(function (global) {
  "use strict";
  ...
  /* ---- Китайский ---------------------------------------------------------
     ...
     без массивов. Не все ключи текущего `ru` здесь есть — список пробелов
     в комментарии наверху файла и в DECISIONS.md. */
  DICT.zh = {
    "unit.shoot": "拍摄",
    "unit.hour": "小时",
    "unit.minute": "分钟",
