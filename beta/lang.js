...
(function (global) {
  ...
  DICT.ru = {
    ...
    "mb.mergeHint":      "Долгий тап поднимает подборку · тащите, чтобы переставить · наведите на другую и держите 2 секунды, чтобы объединить",
  ...
  DICT.en = {
    ...
    "mb.mergeHint":      "Long-press lifts a board · drag to reorder · hold over another for 2 seconds to merge",
