...
(function (global) {
  ...
  DICT.ru = {
    ...
    "mb.mergeHint":      "Долгий тап поднимает подборку · тащите, чтобы переставить · задержитесь на другой, чтобы объединить",
  ...
  DICT.en = {
    ...
    "mb.mergeHint":      "Long-press lifts a board · drag to reorder · hold over another to merge",
