...
(function (global) {
  ...
  DICT.ru = {
    ...
    "loc.studios":     "Студии",
    "loc.isStudio":    "Это студия",
    "loc.studioTel":   "Телефон администратора",
    "loc.studioMins":  "Минут в оплаченном часе",
    "loc.studioKey":   "Ключ студии",
    "loc.studioLoad":  "Загрузить карточку студии",
    "loc.studioLoading":"Загружаю…",
    "loc.studioOk":    "Карточка загружена: {name}",
    "loc.studioBad":   "Студия не ответила. Ключ неверен или нет сети — карточку можно заполнить руками",
    "form.hall":       "Зал",
    ...
    "loc.noStudios":   "Студий пока нет. Заведите её здесь же: имя, адрес и тумблер «Это студия».",
    "form.rent":       "Аренда",
    "form.rentFrom":   "с",
    "form.rentTo":     "до",
  ...
  DICT.en = {
    ...
    "loc.studios":     "Studios",
    "loc.isStudio":    "This is a studio",
    "loc.studioTel":   "Front desk phone",
    "loc.studioMins":  "Minutes in a paid hour",
    "loc.studioKey":   "Studio key",
    "loc.studioLoad":  "Load studio card",
    "loc.studioLoading":"Loading…",
    "loc.studioOk":    "Card loaded: {name}",
    "loc.studioBad":   "The studio did not answer. Wrong key or no network — fill the card by hand",
    "form.hall":       "Hall",
    ...
    "loc.noStudios":   "No studios yet. Add one right here: name, address and the \u201CThis is a studio\u201D switch.",
    "form.rent":       "Rental",
    "form.rentFrom":   "from",
    "form.rentTo":     "to",
  ...
  DICT.es = {
    ...
    "loc.sub": "Buscar por nombre, usar tu ubicación o escribir las coordenadas",
    ...
    "loc.hourly": "Alquiler por hora",
    "loc.studios": "Estudios",
    "loc.isStudio": "Es un estudio",
    "loc.studioTel": "Teléfono de recepción",
    "loc.studioMins": "Minutos en una hora pagada",
    "loc.studioKey": "Clave del estudio",
    "loc.studioLoad": "Cargar ficha del estudio",
    "loc.studioLoading": "Cargando…",
    "loc.studioOk": "Ficha cargada: {name}",
    "loc.studioBad": "El estudio no respondió. Clave incorrecta o sin red — rellena la ficha a mano",
    "form.hall": "Sala",
    ...
    "loc.noStudios": "Aún no hay estudios. Añade uno aquí mismo: nombre, dirección y el interruptor «Es un estudio».",
    "form.rent": "Alquiler",
    "form.rentFrom": "de",
    "form.rentTo": "a",
    "loc.hourlyMins": "Minutos en la hora pagada — avisamos 10 y 5 antes del final",
    ...
    "start.title": "Cómo llevas los papeles",
    "start.sub": "De esto dependen los papeles y la cadena del acuerdo — contrato, factura, anticipo. El idioma de la interfaz no influye: se puede cambiar cuando quieras.",
    "tour.skip": "Omitir",
  ...
  DICT.zh = {
    ...
    "loc.isStudio": "这是影棚",
    "loc.studioTel": "前台电话",
    "loc.studioMins": "付费小时的分钟数",
    "loc.studioKey": "影棚密钥",
    "loc.studioLoad": "加载影棚资料",
    "loc.studioLoading": "加载中…",
    "loc.studioOk": "资料已加载：{name}",
    "loc.studioBad": "影棚未响应。密钥错误或无网络——可手动填写资料",
    "form.hall": "影厅",
    "form.hallNone": "未选择",
    "form.hallPick": "选择影厅",
    "form.link": "关联预订",
    ...
    "card.extendNo": "影棚未延长",
    "loc.noStudios": "还没有影棚。在这里添加：名称、地址和「这是影棚」开关。",
    "form.rent": "租赁",
    "form.rentFrom": "从",
    "form.rentTo": "至",
    "loc.hourlyMins": "付费小时中的分钟数——我们会在结束前10和5分钟提醒",
    "loc.noPlace": "未选择地点",
    "loc.inCity": "在市区",
    "loc.outCity": "在城外",
    ...
    "doc.release": "模型授权书",
    "doc.acceptance": "验收协议",
    "start.title": "您如何处理文书工作",
    "start.sub": "这决定文件和交易链——合同、发票、预付款。界面语言对此没有影响：您可以随时更改。",
    "tour.skip": "跳过",
    "tour.skipAria": "跳过介绍",
    "tour.back": "返回",
    "tour.next": "下一步",
