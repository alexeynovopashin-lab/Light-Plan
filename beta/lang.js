...
(function (global) {
  ...
  DICT.ru = {
    ...
    "mb.mergeHint":      "Долгий тап поднимает подборку · перетащите одну на другую, чтобы объединить",
  ...
  DICT.en = {
    ...
    "mb.mergeHint":      "Long-press lifts a board · drag one onto another to merge",
