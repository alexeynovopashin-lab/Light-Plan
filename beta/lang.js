...
(function (global) {
  ...
  DICT.ru = {
    ...
    "set.appIdNote":    "Отдельный код пришлось бы помнить и куда-то записывать. Номер телефона уже всемирный, уже уникальный и уже ваш — он и работает адресом: по нему организатор события свяжет ваши съёмки со своим планом.",
  ...
  DICT.en = {
    ...
    "set.appIdNote":    "A separate code would be one more thing to remember and write down. Your phone number is already worldwide, already unique and already yours — so it works as the address: an event organiser uses it to link your shoots to their plan.",
