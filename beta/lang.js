...
(function (global) {
  ...
  DICT.ru = {
    ...
    "onb.skip":         "Пропустить",
    "onb.welcomeTitle": "Light Plan",
    "onb.welcomeSub":   "Свет, погода и съёмки — в одном месте. Показать в двух словах, как это работает?",
    "onb.start":        "Ознакомиться",
    "onb.later":        "Пропустить",
    "onb.next":         "Далее",
    "onb.done":         "Начать съёмку",
    "onb.geo.t":        "Место съёмки",
    "onb.geo.d":        "Приложение спросит геопозицию — по ней считаются свет, погода и часовой пояс именно там, где вы снимаете.",
    "onb.disk.t":       "Копия в облаке",
    "onb.disk.d":       "Подключите Яндекс.Диск, Google или Dropbox в настройках — туда уходят копия данных и референсы съёмок.",
    "onb.cal.t":        "Календарь съёмок",
    "onb.cal.d":        "Месяц, неделя или один день — жанр съёмки виден прямо в клетке, а не значком.",
    "onb.slider.t":     "Время в руке",
    "onb.slider.d":     "Один ползунок над таб-баром двигает свет сразу и на «Сегодня», и на карте.",
    "onb.sunmoon.t":    "Солнце и луна",
    "onb.sunmoon.d":    "Купол переключается между ними: фазы, восходы и заходы — для обоих.",
    "onb.map.t":        "Точка на карте",
    "onb.map.d":        "Отметьте, откуда снимаете — компас света покажет направление, тени и золотой час на месте.",
  ...
  DICT.en = {
    ...
    "onb.skip":         "Skip",
    "onb.welcomeTitle": "Light Plan",
    "onb.welcomeSub":   "Light, weather and shoots in one place. Want a quick look at how it works?",
    "onb.start":        "Show me",
    "onb.later":        "Skip",
    "onb.next":         "Next",
    "onb.done":         "Start a shoot",
    "onb.geo.t":        "Where you shoot",
    "onb.geo.d":        "The app will ask for location — it uses it to work out light, weather and time zone right where you shoot.",
    "onb.disk.t":       "A copy in your cloud",
    "onb.disk.d":       "Connect Yandex Disk, Google or Dropbox in settings — your data copy and shoot references go there.",
    "onb.cal.t":        "A calendar for shoots",
    "onb.cal.d":        "Month, week or a single day — the genre of a shoot shows right in the cell, not as a dot.",
    "onb.slider.t":     "Time in your hand",
    "onb.slider.d":     "One slider above the tab bar moves the light on both Today and the map at once.",
    "onb.sunmoon.t":    "Sun and moon",
    "onb.sunmoon.d":    "The dome switches between them: phases, rises and sets for both.",
    "onb.map.t":        "A spot on the map",
    "onb.map.d":        "Mark where you shoot — the light compass shows direction, shadows and golden hour right there.",
