...
(function (global) {
  ...
  DICT.ru = {
    ...
    "mb.sortHint":       "Сортировка · тащите, чтобы переставить · держите на другой 2 секунды, чтобы объединить · тап мимо — выйти",
  ...
  DICT.en = {
    ...
    "mb.sortHint":       "Sorting · drag to reorder · hold over another for 2 seconds to merge · tap outside to finish",
